...
with image.imports():
    from mcts.train_policy_orpo import train_orpo  # Import from our new simplified script

# Create Modal app
app = modal.App("train-policy-orpo", image=image)
...
def main():
    print("Starting full model ORPO training on Modal...")
    try:
        train_policy_orpo.remote()
